...
export default function RealtimeMqttLineChart({
    ...
    password,
    clientId,
    title = "Trend Speed Machine 7, 8, 9 dan 10",
    maxPoints = 120,
    windowMinutes = 5,
    height = 320,
    yDomain = [0, 500],
...
RealtimeMqttLineChartProps) {
    ...
    const [visibleTopics, setVisibleTopics] = useState<Record<TopicKey, boolean>>({
        "AMG/Speed/Line7": true,
        "AMG/Speed/Line8": true,
        "AMG/Speed/Line9": true,
        "AMG/Speed/Line10": true,
    });
...
useEffect(() => {
  ...
  return () => window.removeEventListener("resize", handleResize);
    ...
    const gradients: Record<TopicKey, string> = {
        "AMG/Speed/Line7": "from-green-800 via-emerald-600 to-green-500",
        "AMG/Speed/Line8": "from-blue-800 via-blue-600 to-cyan-500",
        "AMG/Speed/Line9": "from-yellow-800 via-amber-500 to-yellow-400",
        "AMG/Speed/Line10": "from-red-800 via-red-500 to-red-400",
