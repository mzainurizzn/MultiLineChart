...
export default function RealtimeMqttLineChart({
    ...
    password,
    clientId,
    title = "Trend Speed Machine 3, 4 dan 5",
    maxPoints = 120,
    windowMinutes = 5,
    height = 320,
    yDomain = [0, 500],
...
RealtimeMqttLineChartProps) {
    ...
    const [visibleTopics, setVisibleTopics] = useState<Record<TopicKey, boolean>>({
        "AMG/Speed/Line3": true,
        "AMG/Speed/Line4": true,
        "AMG/Speed/Line5": true,
    });
...
useEffect(() => {
  ...
  return () => window.removeEventListener("resize", handleResize);
    ...
    const colors: Record<TopicKey, string> = {
        "AMG/Speed/Line3": "#00ff00",
        "AMG/Speed/Line4": "#00bfff",
        "AMG/Speed/Line5": "#ffcc00",
    };

    const gradients: Record<TopicKey, string> = {
        "AMG/Speed/Line3": "from-green-800 via-emerald-600 to-green-500",
        "AMG/Speed/Line4": "from-blue-800 via-blue-600 to-cyan-500",
        "AMG/Speed/Line5": "from-yellow-800 via-amber-500 to-yellow-400",
    };
